...
def checkpoint(epoch,loss,psnr,ssim,mse):
    ...
    print("Test Avg. PSNR: {:.4f} Avg. SSIM: {:.4f} Avg.MSESsS{:.6f} ".format(psnr,ssim,mse))
...
#attention the flag,which can save the memory if you set flag = True
...
model_weights_file=checkpoint_dir/'199-0.0010-30.0410-0.8879param.pth'
