...
#2.set path and file
save_dir = Path('.')
checkpoint_dir = Path('.') / 'Checkpoints_new'#save model parameters and train record
if checkpoint_dir.exists():
    print 'folder esxited'
else:
    checkpoint_dir.mkdir()

#model_weights_file=checkpoint_dir/'19-0.0012-17.2863-0.6686param.pth'
