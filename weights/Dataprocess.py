...
root_dir=os.getcwd()
DATA_PATH = os.path.join(root_dir,'ValImages','data')
LABEL_PATH = os.path.join(root_dir,'ValImages','label')
...
if __name__ == "__main__":
    ...
    write_hdf5(data, label, os.path.join(root_dir,'TestData40.h5'))
